...
static BLECharacteristic fromRadioSync =
    BLECharacteristic(BLEUuid(FROMRADIOSYNC_UUID_16));
...
// Valid BLE TX power levels as per nRF52840 Product Specification are: "-20 to
// +8 dBm TX power, configurable in 4 dB steps". See
